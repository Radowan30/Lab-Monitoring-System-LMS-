<x-app-layout>
    ...
    <main class="flex-1 lg:ml-64 min-h-screen">
        ...
        <header class="lg:hidden dashboard-room-header flex justify-between items-center"
            style="background-image: url('{{ asset('images/headers/FETEM_room_header.png') }}')">
            <div class="header-content w-full text-center">
                <h1 class="text-xl font-semibold">FETEM Room</h1>
            </div>
        ...
        <div class="p-4">
            <div class="bg-white rounded-lg p-6 shadow-lg">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <button
                        class="flex items-center space-x-1 px-2 py-2 bg-gradient-to-r from-blue-100 to-blue-200 text-blue-600 rounded-lg hover:from-blue-200 hover:to-blue-300 transition-colors">
                        <a href="{{ route('lab_rooms.fetem-chiller') }}">
                            <span>❄️</span>
                            <span class="text-sm font-medium">Inspect Chiller Room</span>
                        </a>
                    </button>
                </div>
