<x-app-layout>
    ...
    <main class="flex-1 lg:ml-64 min-h-screen">
        <!-- Mobile Header -->
        <header class="lg:hidden chiller-room-header flex justify-between items-center"
            style="background-image: url('{{ asset('images/headers/chiller_header.png') }}')">
            <div class="header-content w-full text-center">
                <h1 class="text-xl font-semibold">FETEM Chiller</h1>
            </div>
        ...
        <header class="hidden lg:block chiller-room-header"
            style="background-image: url('{{ asset('images/headers/chiller_header.png') }}')">
            ...
            <div class="bg-white rounded-lg p-6 shadow-lg">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="text-sm text-blue-700 drop-shadow-[0_1.2px_1.2px_#3b82f6]">
