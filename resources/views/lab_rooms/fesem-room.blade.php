<x-app-layout>
    ...
    <main class="flex-1 lg:ml-64 min-h-screen">
        ...
        <header class="lg:hidden dashboard-room-header flex justify-between items-center"
            style="background-image: url('{{ asset('images/headers/FESEM_room_header.png') }}')">
            <div class="header-content w-full text-center">
                <h1 class="text-xl font-semibold">FESEM Room</h1>
            </div>
            ...
            <div class="bg-white rounded-lg p-6 shadow-lg">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <button
                        ...
                        <a href="{{ route('lab_rooms.fesem-chiller') }}">
                            <span>❄️</span>
