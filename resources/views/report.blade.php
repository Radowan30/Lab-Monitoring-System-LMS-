        ...
        <div class="flex-grow p-8">
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 max-w-3xl mx-auto">
                <form id="reportForm" action="{{ route('generate.report') }}">
                    ...
                    <div id="pdfPreviewModal"
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-lg max-w-3xl w-full relative">
                            ...
                            <button id="downloadPDFButton"
                                class="mt-4 bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-800 block mx-auto">
                                Download Report
                            </button>
                        </div>
                    </div>
                    ...
                    <!-- Action Buttons -->
                    <button type="button"
                        class="bg-blue-700 text-white px-6 py-2 rounded-lg hover:bg-blue-600 w-full mb-4"onclick="showPdfPreviewModal()">
                        Generate Report
                    </button>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (labRoom.value) {
        labRoom.dispatchEvent(new Event('change'));
    }
});
            ...
            async function updatePreview() {
                ...
                try {
                    const response = await fetch(
                        `/generate-report?labRoom=${labRoom}&startDate=${startDate}&endDate=${endDate}&problemDescription=${problemDescription}`, {
            ...
            function showPdfPreviewModal(event) {
                ...
                fetch(url, {
                    ...
                    .then(blob => {
                        ...
                        document.getElementById('problemDescriptionPreview').innerText =
                            `Problem Description: ${document.getElementById('problemDescription').value}`;
