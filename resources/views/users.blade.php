...
@endif
    ...
    <div class="max-w-7xl mx-auto my-8 px-4">
        ...
        <div class="flex gap-4 mb-8">
            <button type="button" class="bg-blue-500 text-white px-4 py-2 rounded-md flex items-center gap-2 hover:bg-blue-600" onclick="toggleModal('addUserModal')">+ User</button>
            <input type="text" class="flex-1 px-4 py-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Search user" id="searchInput" onkeyup="searchUsers()">
        </div>
                            ...
                            <div class="col-span-3 flex gap-2">
                                ...
                                <a href="/delete/{{$item->id}}" 
                                    ...
                                    <svg class="w-4 h-4" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M14 3H2V13C2 14.1 2.9 15 4 15H12C13.1 15 14 14.1 14 13V3Z" fill="currentColor"/>
        ...
        <div class="min-h-screen px-4 text-center">
            ...
            <div class="inline-block align-middle max-w-md w-full bg-white rounded-lg text-left shadow-xl transform transition-all my-8">
                <div class="p-4 border-b border-gray-200 flex justify-between items-center">
                    ...
                    <button type="button" class="text-gray-400 hover:text-gray-500 text-2xl" onclick="toggleModal('addUserModal')">×</button>
                </div>
                <div class="p-4">
                    <form action="{{ route('AddUser')}}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="full_name" value="{{old('full_name')}}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter Full Name">
                            @error('full_name')
                        ...
                        <div class="mb-4">
                            ...
                            <select name="is_admin" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" value="{{old('email')}}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter Email">
                            @error('email')
                                <span class="text-red-500 text-sm">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="password" name="password" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter Password">
                            @error('password')
                                <span class="text-red-500 text-sm">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="password" name="password_confirmation" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Confirm Password">
                            @error('password_confirmation')
                                <span class="text-red-500 text-sm">{{$message}}</span>
                            @enderror
                        </div>
                        <button type="submit" class="w-full bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Save</button>
                    </form>
                </div>
            </div>
        </div>
